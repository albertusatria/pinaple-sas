            ...
            <div class="panel-body panel-body-nopadding">
              ...
              <div id="validationWizard" class="basic-wizard">
                ...
                <ul class="nav nav-pills nav-justified" id="form-regis-siswa">
                  <li class="info-siswa">
                  	<a href="#vtab1" data-toggle="tab"><span>Step 1:</span> Registration Information </a>
                  </li>
                  <li class="asal-sekolah">
                  	<a href="#vtab2" data-toggle="tab"><span>Step 2:</span> Student Information </a>
                  </li>
                  <li class="prestasi">
                  	<a href="#vtab3" data-toggle="tab"><span>Step 3:</span> Student Achievements </a>
                  </li>
                  <li class="info-wali">
                  	<a href="#vtab4" data-toggle="tab"><span>Final Step</span> Parents Information </a>
                  </li>
                </ul>
				...
				<div class="tab-pane" id="vtab2">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="siswa[siswa_alamat]" placeholder="Students Address" class="form-control" required/>
						</div>                       
					</div>          
				...
				<div class="tab-pane" id="vtab3">                                                                        
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select class="form-control chosen-select" data-placeholder="Type of Achievement..." name="siswa_prestasi<?php echo $a?>[jenis_prestasi]">
						...
						<div class="col-sm-2">
							<select class="form-control chosen-select" data-placeholder="Choose Achievement Regional..." name="siswa_prestasi<?php echo $a?>[tingkat_prestasi]">
				...
				<div class="tab-pane" id="vtab4">                      
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Full Name <span class="asterisk">*</span></label>
					    <div class="col-sm-6">
							<input type="text" name="siswa[nama_lengkap_ayah]" placeholder="Father's full name" class="form-control" required />
					    </div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" placeholder="Father's Jobs" name="siswa[pekerjaan_ayah]" class="form-control">
						</div>
					</div>            
					...
					<div class="form-group">
					    <h4 class="col-sm-8 control-label text-danger">
					    	Home Teacher Information (please fill this info if students not life with their parents)
					    </h4>
					</div>
					<hr/>                                        
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-6">
					      <input type="text" name="siswa[nama_lengkap_wali]" placeholder="Home Teacher Name" class="form-control" />
					    </div>
					</div>                                           

					<div class="form-group">
					    <label class="col-sm-3 control-label">Home Teacher Job</label>
					    <div class="col-sm-2">
