...
class User extends Admin_base {
	...
	public function index()
	{
		...
		// load template
		$data['layout'] = "setting/user/list";
		$data['javascript'] = "setting/user/javascript/list";
	...
	public function add_process() {
		...
		$this->form_validation->set_rules('user_name', 'Username', 'required|trim|xss_clean|max_length[100]|is_unique[my_user.user_name]');
