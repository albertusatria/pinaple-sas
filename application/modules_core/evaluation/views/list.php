...
?>
    ...
    <div class="contentpanel" style="margin-bottom:-50px">
      <?php if ($message != null ) : ?>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="form-group">
            <label class="col-sm-2 control-label">Active School Year</label>
              <div class="col-sm-2">
                <input type="text" name="grades[tahun-ajaran]" value="<?php echo $year->name?>" class="form-control" disabled/>
              </div>
          </div>                           
          <div class="form-group">
