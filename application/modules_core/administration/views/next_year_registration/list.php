<div class="pageheader">
    <h2><i class="fa fa-users"></i>Student Registration</h2>
...
<form id="regisForm" class="form" method="POST" action="<?php echo base_url(); ?>administration/next_year_registrations/add_process">
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <h4 class="panel-title">New Student Registration Form for Next Year</h4>
              <small>Use this form to add <strong>new student</strong> ( <span class="asterisk">*</span> required) </small> <br> 
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="text" name="siswa_tahun_mulai" class="form-control" value="<?php echo $pmb_year->name ?>" disabled />
              <input type="hidden" name="siswa[siswa_tahun_mulai]" class="form-control" value="<?php echo $pmb_year->id ?>" />
