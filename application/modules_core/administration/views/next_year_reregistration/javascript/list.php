...
jQuery(document).ready(function() {
								...
								'<div class="people-item">'+
								  '<div class="media">'+
								    '<div class="media-body">'+
								      ...
								      '<input type="hidden" class="student-stage-id" value="'+stage_id+'">'+
	...
	jQuery('.row').on('click', '.students-id', function(){
		...
		var stageIDStudent = jQuery(this).find('input.student-stage-id').val();
		jQuery('#initPacketLabel').find('strong').text(idStudent);
		jQuery('#nis_choosen').val(idStudent);
		jQuery('#stage_choosen').val(stageIDStudent);
	});
			                ...
			                if (period_id == null) {
								...
								jQuery('#paymentItemList').append(
									'<div class="form-group">'+
									  ...
									  '<label class="col-sm-4 control-label">'+name+' bulan '+period_nama+' <span class="asterisk">*</span></label>'+
									  '<div class="col-sm-8">'+
