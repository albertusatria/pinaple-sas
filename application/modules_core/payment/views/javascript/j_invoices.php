...
<link href="<?php echo base_url();?>bracket/css/custom.manage.invoice.css" rel="stylesheet">
...
<script src="<?php echo base_url();?>bracket/js/invoices/invoice.management.js"></script>
