      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
           ...
           <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" maxlength="10" placeholder="dd/mm/yy" id="datepicker_mulai" value="<?php echo date("d-m-Y",strtotime($result->start));?>" required/>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" maxlength="10" placeholder="dd/mm/yy" id="datepicker_akhir" value="<?php echo date("d-m-Y",strtotime($result->end));?>" required/>
